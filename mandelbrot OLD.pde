...
void setup() {
  ...
  if(cpLoaded) cp5 = new ControlP5(this);
...
void loadSliders() {
  if(cpLoaded) {
    ...
    cp5.addSlider("c1h").setPosition(indent,50).setRange(0,360).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);
    cp5.addSlider("c2h").setPosition(indent,70).setRange(0,360).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);
    cp5.addSlider("c3h").setPosition(indent,90).setRange(0,360).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);

    cp5.addSlider("c1s").setPosition(indent,140).setRange(0,100).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);
    cp5.addSlider("c2s").setPosition(indent,160).setRange(0,100).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);
    cp5.addSlider("c3s").setPosition(indent,180).setRange(0,100).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);

    cp5.addSlider("c1b").setPosition(indent,230).setRange(0,100).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);
    cp5.addSlider("c2b").setPosition(indent,250).setRange(0,100).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);
    cp5.addSlider("c3b").setPosition(indent,270).setRange(0,100).setHeight(h).setColorForeground(cFore).setColorActive(cActive).setColorBackground(cBack).setColorValueLabel(cVal);

    cp5.addButton("resetSize").setCaptionLabel("Reset Size").setPosition(indent,320).setSize(120,h*2).setColorCaptionLabel(cVal).setColorBackground(cFore).setColorActive(cActive);
  }
}
